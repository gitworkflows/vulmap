...
[Vulmap Template Editor](https://templates.vulmap.sh) is a multi-functional cloud hosted tool designed for creating, running, and sharing Vulmap Templates. It's packed with helpful features for individual and professional users seeking to manage and execute templates.
...
Begin by ensuring you have an account. If not, sign up on [https://templates.vulmap.sh](https://templates.vulmap.sh/) and follow the steps below:

1. Log in to your account at [https://templates.vulmap.sh](https://templates.vulmap.sh).
...
<iframe src="https://templates.vulmap.sh/public/CVE-2023-0297" width="700px" height="700px"></iframe>