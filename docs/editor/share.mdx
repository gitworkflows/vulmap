...
Public templates are designed for ease of sharing. You don't need to be authenticated to share them, meaning there's no need to log in. These templates are mapped with their Template ID, following a static URL pattern. For instance, a public template URL might resemble this: [https://templates.vulmap.sh/public/CVE-2023-35078](https://templates.vulmap.sh/public/CVE-2023-35078). In the given URL, `CVE-2023-35078` is the Template ID representing the template in the [vulmap-templates](https://github.com/khulnasoft-lab/vulmap-templates) project.
