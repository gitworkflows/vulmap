...
If you are unfamiliar with dynamic extractors, we recommend reading the [dynamic extractor](https://docs.vulmap.sh/template-guide/operators/extractors#dynamic-extractor) section first.
