...
- this template uses [payloads](https://docs.vulmap.sh/template-guide/http/http-payloads) to launch a clusterbomb attack with 10 threads and exits on first match
